...
// lib/core/theme.dart 를 이 파일로 교체하세요. (기능/라우팅에는 영향 없음)
//
// 사전 준비: Pretendard 폰트를 pubspec.yaml 에 등록하세요. (PORTING_GUIDE STEP 1)
//   pubspec 에 family: Pretendard 가 없다면 아래 _fontFamily 를 null 로 두면
//   시스템 한글 폰트로 폴백됩니다.
// ─────────────────────────────────────────────────────────────────────────
...
class AppTheme {
  // pubspec 에 Pretendard 를 등록했다면 'Pretendard', 아니면 null (시스템 폰트 폴백).
